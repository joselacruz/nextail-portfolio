...
export default function IconsSocialNetworks() {
  const defaultClasses = 'h-8 w-8 fill-text-secondary';
  const svgArray = [
    {
      id: 'linkedin',
      href: 'https://www.linkedin.com/in/jose-lacruz-3487bb194/',
      render: () => (
        <svg
    ...
    {
      id: 'freelancer',
      href: 'https://www.freelancer.com/u/jclacruz',
      render: () => (
        <svg
          fill="none"
          viewBox="0 0 24 24"
