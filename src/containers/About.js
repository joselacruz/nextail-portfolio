      ...
      >
        <div className=" px-4 mb-8 max-w-xl">
          ...
          <p className="text-text-secondary  max-w-xl font-medium ">
            ...
            functional design. I firmly believe in the importance of simplicity
            in design to ensure an optimal user experience. My goal is to create
            web applications that are elegant, clean and easy to use.
          </p>
        </div>
      </AnimatedVisibleObserver>
